        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedKey = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedKey = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedKey = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_TeamLeads_TeamLeadID",
            ...
            migrationBuilder.CreateTable(
                name: "UserFavoriteLessons",
                columns: table => new
                {
                    UserFavoriteLessonID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteLessons", x => x.UserFavoriteLessonID);
                    table.ForeignKey(
                        name: "FK_UserFavoriteLessons_Lessons_LessonID",
                        column: x => x.LessonID,
                        principalTable: "Lessons",
                        principalColumn: "LessonID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoriteLessons_Users_UserID",
                        column: x => x.UserID,
                        principalTable: "Users",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_TeamLeadID",
                table: "Students",
                column: "TeamLeadID");

            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteLessons_LessonID",
                table: "UserFavoriteLessons",
                column: "LessonID");

            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteLessons_UserID",
                table: "UserFavoriteLessons",
                column: "UserID");
